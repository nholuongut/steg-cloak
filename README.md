...
<p align="justify">
StegCloak is a pure JavaScript steganography module designed in functional programming style, to hide secrets inside text by compressing and encrypting the secret before cloaking it with special unicode invisible characters. It can be used to safely watermark strings, invisible scripts on webpages, texts on social media or for any other covert communication.
<p>
...
- **Configuration file** support to configure StegCloak CLI and to avoid prompts. Read the config docs <a href='https://github.com/nholuongut/steg-cloak/wiki/StegCloak-Configuration-File'>here.</a>
